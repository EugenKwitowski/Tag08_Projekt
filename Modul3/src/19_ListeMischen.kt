fun main() {
    /*
     numbers ist eine Liste mit sortierten Zahlen. Wir wollen diese jetzt aber durchmischen.
     Beispiel: [10,20,30,40] -> [30,10,40,20].
    ...
    var shuffleNumbers = numbers.shuffle()
